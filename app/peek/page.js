    ...
    <div className={styles.main}>
      <div className={styles.content}>
        ...
        <div className={styles.container}>
          ...
          <motion.div  whileHover={{scale:0.9, transition:{duration:0.1}}} transition={{duration:0.3}} className={styles.display}><p>Peek</p></motion.div>
          <motion.div  onClick={() => {handleButtonClick("/sitesearch")}} whileHover={{scale:0.9, transition:{duration:0.1}}} className={styles.display}><p>Site Search</p></motion.div>
